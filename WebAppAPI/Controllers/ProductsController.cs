...
namespace WebAppAPI.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        [HttpGet("ViewProductByBrand/{brandId}")]
        public async Task<ActionResult<IEnumerable<Product>>> ViewProductByBrand(int brandId)
        {
            try
            {
                // Lấy các sản phẩm liên quan đến brandId
